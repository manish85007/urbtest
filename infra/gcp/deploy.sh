...
gcloud run deploy "${SERVICE}" \
  ...
  --set-env-vars "NODE_ENV=production,API_HOST=0.0.0.0,WEB_DIST=/app/apps/web/dist,UAT_SEED=true,COOKIE_SECURE=true,EMAIL_PROVIDER=console,ENABLE_JOBS=true,DATABASE_USER=${DB_USER},DATABASE_NAME=${DB_NAME},CLOUD_SQL_CONNECTION_NAME=${SQL_CONN},GCS_BUCKET=${BUCKET}" \
  --quiet
